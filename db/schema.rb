...
ActiveRecord::Schema.define(version: 20_151_028_004_942) do
  ...
  add_index 'pg_search_documents', %w(searchable_id searchable_type), name: 'index_pg_search_documents_on_searchable_id_and_searchable_type', using: :btree
